...
/**
 * Precompiled ofbiz-node-conventions script plugin.
 **/
public class OfbizNodeConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_OfbizNodeConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.github.node-gradle.node");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OfbizNodeConventions").asSubclass(BasicScript.class);
